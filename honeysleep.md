...
&nbsp;
<br>
위의 이미지는 '푹 잔 느낌' Play 구조를 나타냅니다. 이 Play 구조를 보시고 나면 아래의 코드를 이해하기 좀 더 수월합니다.  
취침 시간은 플레이가 호출 시점과 사용자가 입력한 기상 시간 두가지를 통하여 계산됩니다.  
...
기상 시간에 따라 오직 1개의 반환 시간이 계산된 경우, 그 시간만 알려준 후 서비스는 종료하게 됩니다.
<br>
&nbsp;
<br>   
