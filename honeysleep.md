...
수면은 비렘수면(Non-REM)과 렘수면(REM), 두가지 단계로 나누어집니다. 비렘수면 단계는 숙면 정도에 따라 다시 세 단계로 나누어집니다.

* 수면의 1단계 (N1) : 작은소리에도 금방 눈이 떠지고, 5분 후 2단계로 진입합니다.
* 수면의 2단계 (N2) : 심박수와 체온이 떨어지고 처음에는 약 25분 동안 지속되며 진입시마다 머무르는 시간이 길어집니다.
* 수면의 3단계 (N3) : 가장 깊은 수면 단계로, 맥박과 호흡 등이 안정됩니다.
* REM 수면 단계 : 얕은 수면 상태로, 깨어있을 때와 비슷한 뇌파를 보여주는 단계입니다.
  
<img src="./image/honeysleep/honeysleep_graph.jpg" width="100%" />
  
이렇듯 수면에는 여러 단계가 있기 때문에 우리가 어떤 단계일 때 일어나냐에 따라 기상 시의 기분이 달라집니다.
수면의 2, 3 단계일 때 기상 알람이 울려 잠에서 깨면, 숙면 중에 억지로 깬 것이라 극심한 피로감을 느낄 수 밖에 없습니다.
따라서 보다 개운하게 일어나려면 수면의 1단계, 혹은 REM 수면 단계에서 깨어나야 합니다.

원하는 기상 시각에 수면의 1단계, 혹은 REM 수면 단계에 진입하려면 어떻게 해야할까요? 수면의 단계별 시간은 이미 과학적으로 확인된 바 있습니다. ([『Physiology, Sleep Stages Aakash K. Patel; John F. Araujo.』](https://www.ncbi.nlm.nih.gov/pubmed/30252388))
이에 따르면 약 90분마다 사이클이 한 번 돌아 얕은 수면의 단계에 진입합니다. 따라서 우리가 7, 8시간정도 잠을 자면 그동안 수면 사이클이 대략 5, 6번정도 반복됩니다. 이를 역으로 계산하면 기상 시각이 주어졌을 때 언제 자야 할 지 알 수 있습니다.
...
[![UCC](http://img.youtube.com/vi/gLZCfY8ewgk/0.jpg)](https://youtu.be/gLZCfY8ewgk)  
ㅤ
  ㅤ
  ㅤ
### Play 구조 설명
